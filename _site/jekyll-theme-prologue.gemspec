...
Gem::Specification.new do |spec|
  ...
  spec.version       = "0.3.2"
  spec.authors       = ["Estefania Barreto-Ojeda"]
  spec.email         = ["estefania@ojeda-e.com"]

  spec.summary       = %q{A Jekyll version of the Prologue theme by HTML5 UP.}
  spec.description   = "Modified Jekyll version of the Prologue theme by HTML5 UP by Chris Bobbe"
